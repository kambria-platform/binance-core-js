...
var Transaction = require('@binance-chain/javascript-sdk/lib/tx');
var cryptoJS = {
...
var storage = require('../storage').sessionStorage;
...
class SoftWallet {
  ...
  init = (accOpts, callback) => {
    ...
    if (!accOpts.address || !accOpts.privateKey) return callback(null, engine);
